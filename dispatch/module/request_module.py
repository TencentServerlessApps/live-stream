...
class CreateStreamRequest(RequestBaseMethod):
    ...
    def __init__(self, data):
        inputs = {
            ...
            'SourceUrl': StringModule(name='SourceUrl', data=data.get('SourceUrl', None), null=True,empty=True),
            'SourceUrls': ListModule(name='SourceUrls', data=data.get('SourceUrls', []), null=True, empty=True),
            'Loop': IntModule(name='Loop', data=data.get('Loop', 1), null=True,empty=True),
            'CallbackUrl': StringModule(name='CallbackUrl', data=data.get('CallbackUrl', None), null=True,empty=True),
            'TranscodeParams': StringModule(name='TranscodeParams', data=data.get('TranscodeParams',None), null=True,empty=True),
